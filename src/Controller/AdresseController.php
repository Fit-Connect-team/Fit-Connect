...
class AdresseController extends AbstractController
{
    ...
    #[Route('/back', name: 'app_adresse_indexb', methods: ['GET'])]
    public function indexb(AdresseRepository $adresseRepository): Response
    {
        return $this->render('adresse/indexb.html.twig', [
            'adresses' => $adresseRepository->findAll(),
        ]);
    }
